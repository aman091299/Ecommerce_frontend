    ...
    <div className="h-full">
      <div className="flex gap-6 w-full">
        <div className="w-1/2 px-4 py-4 bg-white shadow-sm rounded">
          <Image
            src="https://cti.farziengineer.co/products/1681-f79e210896d74799bcffd81fe7e36321.png?auto=format&fit=max&w=1200"
            alt="Product Image"
            height={500}
            width={600}
          />
          ...
          <div>
            <div className="text-sm">
              {!isShowText ? (
                <span>{text.substring(0, 256)}...</span>
              ) : (
                <span>{text} </span>
              )}
            </div>
          ...
          <div className="bg-[#f8f4f2]  shadow-sm w-full ">
            ...
            <div className="flex justify-between px-4 py-4">
              <div className="flex items-center">
                <span className="font-semibold text-xl">₹899.00</span>
                <span
