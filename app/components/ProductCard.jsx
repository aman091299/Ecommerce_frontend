...
const ProductCard = ({ image, name, description, actualPrice,serves,combo,price }) => {
        ...
        <div className="card bg-base-100 w-70 shadow-sm px-3 py-2 mt-3">
          <figure className="relatives">
            ...
            <div className="absolute top-34 left-3">
              ...
              <span className="bg-orange-400 px-2 rounded py-1 font-semibold text-white">Save ₹{actualPrice-price}.00</span>
            </div>
          </figure>
          <div className="card-body p-1">
            ...
            <p className=" text-[#a9a9a9] w-64  text-sm line-clamp-3">{description}</p>
            <div className="flex justify-between py-2">
              ...
              <button className="btn btn-neutral text-[12px] flex items-center">
                          <svg className="flex items-center my-auto" width="12" height="16" viewBox="0 0 15 15"
